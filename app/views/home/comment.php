    <div class="comment">
          ...
          <div class="col-12 shadow-sm p-4 mb-4 bg-white rounded">
              ...
              <div class="d-flex align-items-center">
                <img src="<?= BASEURL;?>/img/users/profile/<?=$data["profile"]?>"  class="rounded-circle"  width="50px"  alt="">
             ...
             <div class="mb-4 mt-2">
                <div class="d-flex ml-2 mt-2 justify-content-between align-items-center">
                  <img src="<?= BASEURL;?>/img/users/profile/<?=$user["profile"]?>" class="rounded-circle d-md-block d-lg-block  d-none " width="50px" alt="">
