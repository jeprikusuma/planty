    ...
    <div class="container d-flex flex-column flex-lg-row flex-md-row justify-content-center">
      ...
      <div class="aside col-md-3 col-lg-3 col-12 d-flex flex-column h-50">
        ...
        <div class="p-3 mb-4 rounded order-2">
          ...
          <a href="#" class="aside-element  badge p-3 mt-2 rounded-pill d-flex text-dark align-items-center text-center animate__animated animate__fadeInLeft animate" data-toggle="modal" data-target="#static-about">
            <i class="fas fa-info-circle"></i>
            <p class="my-auto ml-3">About</p>
          </a>
          <a href="#" class="aside-element  badge p-3 mt-2 rounded-pill d-flex align-items-center text-danger text-center animate__animated animate__fadeInLeft animate" data-toggle="modal" data-target="#single-logout">
      ...
      <!-- Main content -->
      <div class="col-md-6 col-lg-6 mb-5 mx-0 mx-md-2 mx-lg-2 col-12 order-3 order-md-2 order-lg-2">
        <!-- posting-->
        <div class="posting">
          <div class="col-12 shadow-sm py-3 px-4 mb-4 bg-white rounded animate__animated animate__fadeInUp animate">
            <!-- input -->
